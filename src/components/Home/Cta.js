...
export default function Cta() {
  ...
  return (
    <section className="relative min-h-screen bg-[#cfcfcf] flex flex-col items-center justify-center overflow-hidden px-4 pt-8 pb-8 sm:pt-16 sm:pb-16" id="contact">
      ...
      <div className="faq-container w-full max-w-4xl bg-white shadow-2xl rounded-lg overflow-hidden">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 p-8 bg-black text-white flex flex-col justify-between">
            <header>
              <h1 className="text-3xl font-bold mb-6">ÚNETE A NUESTRA VISIÓN</h1>
          ...
          <div className="md:w-1/2 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" aria-labelledby="cta-form">
              <div>
